    ...
    try:
        for pid in peptide_ids:
            ...
            for hit in pid.getHits():
                ...
                if not hit.metaValueExists("SpecEValue_score") and hit.metaValueExists("MS:1002052"):
    ...
    try:
        ...
        for hit_info in pid_info['hits']:
            ...
            if hit.metaValueExists("MS:1002052"):
                meta_fields.append(("SpecEValue_score", float(hit.getMetaValue("MS:1002052"))))
...
def process_peptide_hit(hit, spectrum, logger):
    ...
    try:
        ...
        if debug:
            ...
            logger.info(f"Legacy PhosphoRS score: {result_cache['PhosphoRS_pep_score']}")
                ...
                if res['status'] == 'success':
                    ...
                    for hit_src, hit_res in zip(pid_src.getHits(), res['hits']):
                        ...
                        for k in [
                            ...
                            'PhosphoRS_pep_score', 'PhosphoRS_site_probs', 'SpecEValue_score'
                        ]:
